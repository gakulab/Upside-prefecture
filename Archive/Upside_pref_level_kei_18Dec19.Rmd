...
```{r}
Temp_User=1
if(Temp_User==1){setwd("~/Google_Drive/Upside_Kei/Upside_project/Current_Working_Data/Datasets")}else if
...
if(Temp_User==1){setwd("~/Google ドライブ/Upside_Kei/Upside_project/Current_Working_Data/Datasets")}else if(Temp_User==2){setwd("~/Dropbox/#_0_gakuGroup/Upside_Kei.K/Output")}else if(Temp_User==3){setwd("C:/Users/aquak/Dropbox/Upside_Kei.K/timeseries/prefecture/harvest")}
