...
(Temp_User==2){setwd("~/Dropbox/#_0_gakuGroup/Upside_Kei.K/Upside_project/Current_Working_Data/Datasets")}else if
(Temp_User==3){setwd("C:/Users/aquak/Dropbox/Upside_Kei.K")}
...
colnames(dt.price)<-c("year","prefecture","fish","value_million_JPY","alphabet_pref","pref_code","region_kaiku","region","region_name")
