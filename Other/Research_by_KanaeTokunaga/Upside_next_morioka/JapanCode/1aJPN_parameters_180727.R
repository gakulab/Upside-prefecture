...
setwd("~/Dropbox/EDFUPSIDE2018/RunUpside_Cuba_Feb2018/R_scripts/GUM_KK/R/")
file.sources = list.files(pattern="*.R")
sapply(file.sources,source,.GlobalEnv)
file.sources = list.files(pattern="*.rda")
sapply(file.sources,load,.GlobalEnv)
setwd("~/Dropbox/EDFUPSIDE2018/RunUpside_Cuba_Feb2018/R_scripts/GUM_KK/data/")
data.sources = list.files(pattern="*.rda")
sapply(data.sources,load,.GlobalEnv)

## Read dataframe created from JFA production statistics & stock assessments
setwd("~/Dropbox/EDFUPSIDE2018/Data Collection/Cleaning/cleanedData")
dt.prod <- read.csv("dataProductionValueByStock_0530.csv")
...
setwd("~/Dropbox/EDFUPSIDE2018/Data Collection/Cleaning/miscData")
fish.name <- read.csv("fishName.csv")
...
asfis <- read.csv("1ASFIS 6 languages_2017.csv")
...
#write.csv(resil, file = "resilience.csv") #This is in miscData folder
#resil <- read.csv("resilience.csv")
...
setwd("~/Dropbox/EDFUPSIDE2018/Data Collection/Cleaning")
write.csv(fishery.list, file = "miscData/fisheryList_180530.csv")
...
### missing price info >> 4184 data points
...
setwd("~/Dropbox/EDFUPSIDE2018/Data Collection/Cleaning/")
#write.csv(dt.prod6.clean, "cleanedData/dataProdClean_0530.csv")

setwd("~/Dropbox/EDFUPSIDE2018/Data Collection/Cleaning/")
library(reshape2)
dt.prod6.clean2 <- read.csv("cleanedData/dataProdClean_0530.csv")
dt.prod6.clean2 <- dt.prod6.clean2[,-c(1, 11)]
...
#write.csv(dt.prod6.clean2, "cleanedData/dataProdClean_0621.csv")


dt.prod6.clean3 <- read.csv("cleanedData/dataProdClean_0530.csv")
...
dt.prod6.clean3 <- dt.prod6.clean3[,-c(1, 10, 11)]
...
#write.csv(dt.prod6.clean3, "cleanedData/dataPriceClean_0727.csv")

setwd("~/Dropbox/EDFUPSIDE2018/JapanUpside_2018")
#write.csv(dt.prod6.clean2, file = "data/1japan_production.csv")
#write.csv(dt.prod6.clean3, file = "data/1japan_price.csv")
