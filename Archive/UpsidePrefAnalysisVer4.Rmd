...
lapply(1:length(unique(dt.comp$alphabet)), function(x){
  ...
  dt.graph <- dt.comp %>%
    ...
    summarise(prefecture,
              年 = time,
              compare_moving_mean5 = rollmean(compare_t, k = 5, fill = NA),
              compare_moving_mean10 = rollmean(compare_t, k = 10, fill = NA),
              compare_moving_mean15 = rollmean(compare_t, k = 15, fill = NA),
              compare_moving_mean20 = rollmean(compare_t, k = 20, fill = NA)) %>%
    ungroup()
 ...
 g1 <- ggplot(dt.graph,aes(x = 年, y = compare_moving_mean5,col=管理シナリオ)) +
  　theme_light(base_family = "Osaka") +
  　geom_line(size=1.5) +
  　labs(title = paste(unique(dt.graph$prefecture),"過不足漁獲量","5年移動平均", sep = " "),
  　     x = "年数",
    　   y = "漁獲量(t)") +
    geom_text_repel(
 ...
 g2 <- ggplot(dt.graph,aes(x = 年, y = compare_moving_mean10,col=管理シナリオ)) +
  　theme_light(base_family = "Osaka") +
  　geom_line(size=1.5) +
  　labs(title = paste(unique(dt.graph$prefecture),"過不足漁獲量","10年移動平均", sep = " "),
  　     x = "年数",
    　   y = "漁獲量(t)") +
    geom_text_repel(
  ...
  　theme_light(base_family = "Osaka") +
  　geom_line(size=1.5) +
  　labs(title = paste(unique(dt.graph$prefecture),"過不足漁獲量","15年移動平均", sep = " "),
  　     x = "年数",
    　   y = "漁獲量(t)") +
    geom_text_repel(
  ...
  　theme_light(base_family = "Osaka") +
  　geom_line(size=1.5) +
  　labs(title = paste(unique(dt.graph$prefecture),"過不足漁獲量","20年移動平均", sep = " "),
  　     x = "年数",
    　   y = "漁獲量(t)") +
    geom_text_repel(
  ...
  #setwd("/Volumes/GoogleDrive/Shared drives/gakuLab_Research_Upside/Upside-U.Iwate/Outputs/Moving_mean_catch")
...
lapply(1:length(unique(UpsideResult$prefecture)),function(x){
 ...
 g1 <- ggplot(dt.graph,aes(x = 年, y = total_pref_catch_moving_mean5,col=管理シナリオ)) +
  　theme_light(base_family = "Osaka") +
  　geom_line(size=1.5) +
  　labs(title = paste(unique(dt.graph$prefecture),"5年移動平均", sep = " "),
  　     x = "年数",
    　   y = "漁獲量(t)") +
    geom_text_repel(
      data = subset(dt.graph, 年 == 48),
 ...
 g2 <- ggplot(dt.graph,aes(x = 年, y = total_pref_catch_moving_mean10,col=管理シナリオ)) +
  　theme_light(base_family = "Osaka") +
  　geom_line(size=1.5) +
  　labs(title = paste(unique(dt.graph$prefecture),"10年移動平均", sep = " "),
  　     x = "年数",
    　   y = "漁獲量(t)") +
    geom_text_repel(
      data = subset(dt.graph, 年 == 45),
  ...
  　theme_light(base_family = "Osaka") +
  　geom_line(size=1.5) +
  　labs(title = paste(unique(dt.graph$prefecture),"15年移動平均", sep = " "),
  　     x = "年数",
    　   y = "漁獲量(t)") +
    geom_text_repel(
      data = subset(dt.graph, 年 == 43),
  ...
  　theme_light(base_family = "Osaka") +
  　geom_line(size=1.5) +
  　labs(title = paste(unique(dt.graph$prefecture),"20年移動平均", sep = " "),
  　     x = "年数",
    　   y = "漁獲量(t)") +
    geom_text_repel(
      data = subset(dt.graph, 年 == 40),
