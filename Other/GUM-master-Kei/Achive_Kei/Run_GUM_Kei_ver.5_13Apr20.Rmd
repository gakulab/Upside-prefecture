...
setwd("~/Upside-prefecture/Other/GUM-master-Kei/R_Kei")
...
#4/14kei:回帰の比較用
setwd("~/Upside-prefecture/Other/GUM-master-Kei/data")
...
fish1 <- fish %>%
  ...
  left_join(lifehistory,by=c("CommName","SciName","SpeciesCat")) %>%
