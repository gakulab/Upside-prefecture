...
dataInput = read.csv("data/4Inputs_for_proj_disc5per_0727.csv", header=TRUE,stringsAsFactors=FALSE)
...
write.csv(masterOutput,file="output/japan_072718_disc10per_mo_opt.csv")


recoveryOutput$implementYear = (recoveryOutput$implementYear + 1)
write.csv(recoveryOutput,file="output/japan_072718_disc10per_recovery_opt.csv")

npvOutput$implementYear = (npvOutput$implementYear + 1)
write.csv(npvOutput,file="output/japan_072718_disc10per_npv_opt.csv")

## opt at the end of csv names indicates results from model with policy that is optimized once at beginning


##########################PLOTTING!!!
masterOutput<-read.csv("output/japan_072718_disc10per_mo_opt.csv", header=T, stringsAsFactors = F)
recoveryOutput<-read.csv("output/japan_072718_disc10per_recovery_opt.csv", header=T, stringsAsFactors = F)
npvOutput<-read.csv("output/japan_072718_disc10per_npv_opt.csv", header=T, stringsAsFactors = F)
