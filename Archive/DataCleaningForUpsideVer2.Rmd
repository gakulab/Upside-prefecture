...
Temp_Data_Catch <- read.csv("/Volumes/GoogleDrive/My Drive/Upside-prefecture/Other/Research_by_KanaeTokunaga/Upside_next_morioka/upside_20181225/output/japan_20211219_mo_opt.csv")
...
#震災の影響を受けない県に関しては、2009-2019の期間にしている
...
Temp_Data_Catch1 <- dplyr::left_join(Temp_Data_Catch,translation_kanae_kei,by="fishery") %>%
  ...
  #select(year,fish_stock,management,biomass,harvest1,profit1,BvBMSY,FvFMSY1,harvest) %>% #Temp_Data_Catch_Keiを使用する場合
...
dt.comp2 <- dt.comp %>%
  mutate(pref_catch = harvest1*rate_catch,
...
setwd("/Volumes/GoogleDrive/My Drive/Upside-prefecture/Data_Working")
save(list = c("UpsideResultDetail","UpsideResult","CatchRate","ProcessingData","ProcessingDataDetail"),file = "UpsideDataForResearch3.rda")
