...
## Section 1ユーザーの切替  
 - Temp_User=１の時、Google_Driveのディレクトリ(Mac）  
 - Temp_User=２の時、gakuが使用
 - Temp_User=３の時、慧が使用（Mac Local Directory）
```{r}
Temp_User=1
if(Temp_User==1){setwd("~/GD_Research_Upside/Upside_project/Data_Working")}else if
(Temp_User==2){setwd("~/Dropbox/#_0_gakuGroup/Upside_Kei.K")}else if
(Temp_User==3){setwd("/Users/keikawamura/Google ドライブ/Upside_Kei/Upside_project/Current_Working_Data")}
...
(Temp_User==2){setwd("~/Dropbox/#_0_gakuGroup/Upside_Kei.K")}else if
(Temp_User==3){setwd("/Users/keikawamura/研究/Upside/Upside_project/Current_working_data/Datasets")}
...
dt.weight <- dt.weight %>%
  select(prefecture,year,fish,weight_t,alphabet,pref_code,region_kaiku,region,region_name)
